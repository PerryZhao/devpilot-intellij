...
public class DeepThinkingEventProcessor {
    ...
    private void processMcpDecision(Map<String, String> eventData, String tag) {
        PartialMessage partialMessage = preparePartialMessage(eventData, tag);
    ...
    private PartialMessage preparePartialMessage(Map<String, String> eventData, String tag) {
        ...
        if (sessionManager.getCurrentSession().isAbort()) {
